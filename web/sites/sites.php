...
$sites['http://local.belive.fr'] = 'local.belive.fr';
$sites['http://local.sandbox-belive.fr'] = 'local.sandbox-belive.fr';

$sites = array (
  'local.belive.fr' => 'local.belive.fr',
  //'http://local.belive.fr' => 'local.belive.fr',
  //'local.sandbox-belive.fr' => 'local.sandbox-belive.fr',
  'local.sandbox-belive.fr' => 'local.sandbox-belive.fr',
  //'pub.drupalvm.dev' => 'api-store.deploy05public.frvmt0001907.dcn.fr.carrefour.com',
  //'priv.drupalvm.dev' => 'api-store.dev03private.frvmt0001907.dcn.fr.carrefour.com',
  //'http://pub.drupalvm.dev' => 'api-store.dev05public.frvmt0001907.dcn.fr.carrefour.com',
  //'http://pub.drupalvm.dev' => 'api-store.deploy05public.frvmt0001907.dcn.fr.carrefour.com',
  //'http://priv.drupalvm.dev' => 'api-store.dev03private.frvmt0001907.dcn.fr.carrefour.com',
);