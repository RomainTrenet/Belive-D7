...
// The Band Booking default site informations
...
function band_booking_profile_details(){
  $details['language'] = "fr";
  return $details;
}
 ...
 */
function band_booking_erase_modules_entry(array $modules) {
  db_delete('system')
 ...
 * @param $install_state
 */
function band_booking_install_tasks(&$install_state) {
  return array (
    'apply_default_features' => array(
      ...
      'function' => 'band_booking_apply_default_features',
    )
  ...
  /*,
    'refresh_default_translations' => array(
      ...
      'type' => 'batch',
      'run' => 'INSTALL_TASK_RUN_IF_REACHED',
      'function' => 'band_booking_refresh_default_translations',
    ),
    'apply_default_translations' => array(
      ...
      'type' => 'batch',
      'run' => 'INSTALL_TASK_RUN_IF_REACHED',
      'function' => 'band_booking_apply_default_translations',
    )
  */
  );
}
 ...
 */
function band_booking_form_install_configure_form_alter(&$form, $form_state) {
